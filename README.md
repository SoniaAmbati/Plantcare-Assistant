...
Uses a lightweight image heuristic and green channel analysis as a placeholder for species detection.
...
- Tested on Node.js 18+. `sharp` downloads native binaries during install
