...
Simple web app: upload a plant photo and get watering, sunlight, and care suggestions. Uses a lightweight image heuristic (green channel analysis) as a placeholder for species detection.
